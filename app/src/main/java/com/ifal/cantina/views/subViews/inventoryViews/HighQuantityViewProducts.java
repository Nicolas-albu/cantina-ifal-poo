...
public class HighQuantityViewProducts extends AView {

    public HighQuantityViewProducts() {
        super();
    }
        ...
        List<String> questions = new ArrayList<>() {
            {
                ...
                add("Digite a quantidade a aumentar do produto: ");
            }
        };

        System.out.println("===========================================");
        System.out.println("Aumento da Quantidade de Produto no Estoque");
        System.out.println("===========================================\n");
